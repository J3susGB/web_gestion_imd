...
<form method="post" class="partidos__partido partidos__filtro partidos__filtro-especifico">
    ...
    <div class="partidos__campo">
        ...
        <input
            ...
            value="<?php echo $arbitro->apellido2 ? $arbitro->apellido2 : ''; ?>" />    </div>
    ...
    <div class="partidos__campo">
        ...
        <input
            ...
            value="<?php echo $arbitro->email? $arbitro->email: ''; ?>" />    </div>
    ...
    <div class="partidos__campo">
        ...
        <input
            ...
            value="<?php echo $arbitro->telefono ? $arbitro->telefono : ''; ?>" />    </div>
    ...
    <div class="partidos__campo">
        ...
        <input
            ...
            value="<?php echo $arbitro->codigo_postal ? $arbitro->codigo_postal : ''; ?>" />    </div>
    ...
    <div class="partidos__campo">
        ...
        <div class="estado-opciones">
            <label class="estado-label">
                <input <?php echo $arbitro->modalidad === "1" ? 'checked' : ''; ?> type="radio" name="modalidad" value="1">
                <span class="radio-custom"></span>
                Fútbol
            </label>
            <label class="estado-label">
                <input <?php echo $arbitro->modalidad === "2" ? 'checked' : ''; ?> type="radio" name="modalidad" value="2">
                <span class="radio-custom"></span>
                Fútbol Sala
            </label>
        </div>
